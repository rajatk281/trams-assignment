...
const Footer = () => {
    return (
        <div className='w-full bg-[#d9ebcf] relative'>
            ...
            <h1 className='text-center pt-8'>Subscribe to <br /> our newsletter</h1>
            <span className='flex text-center justify-center mt-8 text-[#4e4a54]'>To make your stay special and even more memorable</span>
            ...
            <hr className='border-t border-[#b8c6a9] my-16 mx-auto max-w-[1226px]' />
            ...
            <div className="ellipse absolute top-50 right-10 rotate-185"></div>
        </div>
    )
}
